...
MakerViewController.prototype.loadDOM = function() {
	...
	this.listNameDiv.setAttribute( 'title', "Enter the unit's name here." );
...
MakerViewController.prototype.updateGroupsBasedOnDOM = function() {
	for ( var i = 0; i < this.unitMakerViews.length; i++ ) {
		...
		var updatedHeaders = [];
		for ( var j = unitMakerView.unitStats.length - 1; j > -1; j-- ) {
		...
		console.log( unitMakerView.unitOptionGroups );
...
MakerViewController.prototype.saveCurrentListButtonClicked = function( e ) {
	...
	$.post( 'http://localhost:4730/armylist', packetForExport );
}